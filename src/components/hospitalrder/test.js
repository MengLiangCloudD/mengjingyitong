        ...
        Mdate.prototype={
            ...
            initScroll:function(){
                ...
                monthScroll=new iScroll("monthwrapper",{
                    snap:"li",
                    vScrollbar:false,onScrollEnd:function(){
            ...
            refreshScroll:function(){
                ...
                inputYear=inputYear||that.beginYear;inputMonth=inputMonth||that.beginMonth;
            ...
            dateSure:function(){
                ...
                sureBtn.onclick=function(){
                    ...
                    that.acceptId.setAttribute("data-day",dayTag);that.dateCancel()
                };
