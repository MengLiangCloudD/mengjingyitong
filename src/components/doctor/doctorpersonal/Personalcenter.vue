    ...
    <div class="ge" style="height:100%;overflow: auto;">
        <div class="tittle" style="background: rgb(0, 187, 187);color:white">
         ...
         <div class="content">
              ...
              <p style="text-align: center;border:0;"  class="butn"><span class="btn" @click="modalispayment">退出登陆</span> </p>
              <Modal v-model="ispayment"  @on-ok="quite" title="挂号提示信息">
                <p>您确认要退出吗</p>
              </Modal>
