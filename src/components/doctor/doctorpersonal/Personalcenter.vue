        ...
        <div class="tittle" style="background: rgb(0, 187, 187);color:white">
         ...
         <div class="content">
              <div class="userssss"  style="padding-left: 5%; border-bottom:1px solid #ccc;">
                ...
                <div style="position: absolute;right: 7%;top: 28px;" @click="goReplylist()">
                  <svg t="1565249436768" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="8252" width="30" height="30"><path d="M598.51264 128.44032c0-45.70624-38.7328-82.92864-86.51776-82.92864-47.68256 0-86.50752 37.13024-86.50752 82.92864 0 4.66944 0.39936 9.25184 1.17248 13.70112-119.46496 39.92064-217.47712 162.49344-217.47712 307.51744v114.17088s0 164.43392-42.1376 165.8624c-25.12896 0-44.37504 18.57024-44.37504 41.47712 0 23.06048 19.36384 41.46688 43.24864 41.46688h692.16256c24.00256 0 43.24864-18.56 43.24864-41.46688 0-23.0656-19.35872-41.47712-43.24864-41.47712-43.25376 0-43.25376-164.69504-43.25376-164.69504V449.66912c0-145.20832-91.64288-267.83232-217.46688-307.62496 0.75264-4.4288 1.152-8.97024 1.152-13.60384z m43.264 725.5808c-0.128 68.77184-57.69216 124.47232-129.78176 124.47232-71.58784 0-129.64864-55.46496-129.78176-124.47232h259.56352z" p-id="8253" fill="#00BBBB"></path></svg>
                </div>
              </div>
              <div class="content2" v-for="(item,index) in docxiang" :key="index" style="padding-bottom:0">
                    ...
                    <p>
                        ...
                        <span >医生简介</span>
                        <span style="width:75%; text-align: right;position: absolute;right: 7%;top: 20px;" @click="gomodal11">
